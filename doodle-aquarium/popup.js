...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const els = {
    ...
    bulkSpeedMultiplier: document.getElementById('bulk-speed-multiplier'),
    bulkSizeMultiplier: document.getElementById('bulk-size-multiplier'),
    bulkInteractionType: document.getElementById('bulk-interaction-type'),
    bulkInteractionStrength: document.getElementById('bulk-interaction-strength'),
    bulkSpeedDisplay: document.getElementById('bulk-speed-display'),
    bulkSizeDisplay: document.getElementById('bulk-size-display'),
    bulkStrengthDisplay: document.getElementById('bulk-strength-display'),
    bulkGravity: document.getElementById('bulk-gravity-multiplier'),
    bulkGravityDisplay: document.getElementById('bulk-gravity-display'),
    ...
    modalInteractionType: document.getElementById('modal-interaction-type'),
    modalInteractionStrength: document.getElementById('modal-interaction-strength'),
    modalSpeedDisplay: document.getElementById('modal-speed-display'),
    modalSizeDisplay: document.getElementById('modal-size-display'),
    modalStrengthDisplay: document.getElementById('modal-strength-display'),
    modalGravity: document.getElementById('modal-gravity-multiplier'),
    modalGravityDisplay: document.getElementById('modal-gravity-display'),
    modalBounciness: document.getElementById('modal-bounciness-multiplier'),
    modalBouncinessDisplay: document.getElementById('modal-bounciness-display'),
